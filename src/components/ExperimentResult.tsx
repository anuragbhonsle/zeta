...
export default function ExperimentResult() {
  ...
  return (
    <div className="w-full text-left rounded-3xl border border-zinc-800 bg-black p-6 sm:p-8 shadow-xl transition-all duration-200">
      {/* Header */}
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:gap-4">
        <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-4 transition-colors hover:bg-zinc-900">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
          <div className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400">
            <HiSparkles className="h-3.5 w-3.5 text-emerald-400" />
            Entry Condition
          </div>
        ...
        {experiment.filters && experiment.filters.length > 0 && (
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
            <div className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400">
              <HiFunnel className="h-3.5 w-3.5 text-zinc-400" />
              Regime Filters
            </div>
        ...
        {/* Objective */}
        <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/90 p-4 text-white shadow-sm">
          <div className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400">
            <HiBeaker className="h-3.5 w-3.5 text-emerald-400" />
            Research Objective
          </div>
